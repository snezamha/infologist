...
export default async function ProjectMediaCropPage({ params }: Props) {
  ...
  return (
    <SiteProjectMediaEditView domainId={domainId} file={file} mode="crop" />
  );
}
